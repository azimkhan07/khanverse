...
class ContentSeeder extends Seeder
{
    ...
    {
        $faqs = [
            ['question' => 'How does SkillNest work?', 'answer' => 'SkillNest connects freelancers (sellers) with clients (buyers). Sellers offer services, buyers purchase them, and projects are managed through our platform.', 'sort_order' => 1, 'status' => true],
            ...
            ['question' => 'What are the fees?', 'answer' => 'SkillNest charges a platform fee of 10% on each completed transaction. There are no upfront costs.', 'sort_order' => 3, 'status' => true],
        ...
        $testimonials = [
            ['name' => 'John Smith', 'designation' => 'CEO', 'company' => 'TechCorp', 'rating' => 5, 'review' => 'SkillNest made it incredibly easy to find talented developers. Highly recommended!', 'sort_order' => 1, 'status' => true],
            ['name' => 'Sarah Johnson', 'designation' => 'Marketing Manager', 'company' => 'GrowthCo', 'rating' => 5, 'review' => 'As a freelancer, SkillNest has helped me grow my client base significantly.', 'sort_order' => 2, 'status' => true],
        ...
        $sections = [
            ['section_key' => 'hero', 'title' => 'Find the Perfect Freelancer', 'subtitle' => 'SkillNest', 'description' => 'Connect with talented professionals and get your project done.', 'button_text' => 'Get Started', 'button_url' => '/register', 'sort_order' => 1, 'status' => true],
            ...
            ['section_key' => 'cta', 'title' => 'Ready to Get Started?', 'subtitle' => 'Join SkillNest', 'description' => 'Sign up today and start your journey.', 'button_text' => 'Sign Up Now', 'button_url' => '/register', 'sort_order' => 4, 'status' => true],
        ];
