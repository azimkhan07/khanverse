    ...
    <div class="container-fluid">
            ...
            <div class="col-lg-3 col-md-6 mb-3">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        ...
                        <h3 class="text-primary"> {{ $openProjects }} </h3>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 mb-3">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        ...
                        <h3 class="text-warning"> {{ $inProgressProjects }} </h3>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 mb-3">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        ...
                        <h3 class="text-success"> {{ $completedProjects }} </h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-body">
                ...
                <form method="GET" action="{{ route('buyer.projects.index') }}">
                    <div class="row">
                        ...
                        <div class="col-md-2 mb-2">
                            <a href="{{ route('buyer.projects.index') }}" class="btn btn-secondary w-100"> Reset </a>
                        </div>
                    </div>
                </form>
            </div>
                        ...
                        <tbody>
                            @forelse($projects as $project)
                                <tr>
                                    ...
                                    <td> {{ optional($project->seller)->full_name ?? '-' }} </td>
                                    <td> ₹{{ number_format($project->budget, 2) }} </td>
                                    <td> {{ $project->deadline ? \Carbon\Carbon::parse($project->deadline)->format('d M Y') : '-' }}
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="{{ route('buyer.projects.show', $project->id) }}"
